    ...
    const { data, error } = await supabase.from("School").insert([
      {
        ...
        BoardaccreditationId: formData.boardaccreditationId ? parseInt(formData.boardaccreditationId) : null,
      },
    ]);
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              ...
              <Grid container spacing={1}>
                {['library', 'sports', 'computerLab', 'scienceLab', 'auditorium'].map((facility) => (
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                label="Accreditation ID"
                name="boardaccreditationId"
                value={formData.boardaccreditationId}
                onChange={handleInputChange}
                fullWidth
              />
            </Grid>
