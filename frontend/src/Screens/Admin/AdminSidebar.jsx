...
//           path: "/admin/notice/publish-notice",
//         },
//       ],
//     },
  ...
  const menuItems = [
    { icon: <HomeIcon />, label: "Home", path: "/admin" },
    {
      ...
      subItems: [
        ...
        { icon: <DeleteIcon />, label: "Delete School", path: "/admin/delete-school" },
      ],
    },
    {
      icon: <SchoolIcon />,
      ...
      subItems: [
        ...
        { icon: <DeleteIcon />, label: "Delete Teacher", path: "/admin/delete-teacher" },
        { icon: <TransferWithinAStationIcon />, label: "Transfer Teacher", path: "/admin/transfer-teacher" },
      ],
    },
    { icon: <ChildCareIcon />, label: "All Students", path: "/admin/all-students" },
    {
      ...
      label: "Notices",
      subItems: [
        { icon: <NotesIcon />, label: "Notices", path: "/admin/notice/all" },
        { icon: <PublishIcon />, label: "Publish Notice", path: "/admin/notice/publish-notice" },
      ],
    },
    {
      icon: <AssessmentIcon />,
      label: "Reports",
      subItems: [
        { icon: <TaskIcon />, label: "Received Reports", path: "/admin/received-reports" },
        { icon: <PendingIcon />, label: "Pending Reports", path: "/admin/pending-reports" },
      ],
    },
  ];
          ...
          return (
            <div key={index}>
              <ListItem disablePadding>
                ...
                >
                  <ListItemIcon
                    sx={{ color: hasActiveSubItem(item.subItems) ? "#0546ad" : "inherit" }}
                  >
                    {item.icon}
                  </ListItemIcon>
                  {!collapsed && (
                ...
                <List component="div" disablePadding>
                  {item.subItems.map((subItem, subIndex) => (
                    <ListItem disablePadding key={subIndex}>
                      ...
                      >
                        <ListItemIcon
                          sx={{ color: isActive(subItem.path) ? "white" : "inherit" }}
                        >
                          {subItem.icon}
                        </ListItemIcon>
                        {!collapsed && (
