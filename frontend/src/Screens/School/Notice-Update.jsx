...
//           (notice) =>
//             new Date(notice.EndDate) >= pkNow &&
//             (notice.CreatedType === "Admin" ||
...
//                 >
//                   <TableRow>
//                     <TableCell><strong>NoticeID</strong></TableCell>
//                     <TableCell><strong>Type</strong></TableCell>
//                     <TableCell><strong>SubType</strong></TableCell>
//                     <TableCell><strong>Title</strong></TableCell>
//                     <TableCell><strong>Message</strong></TableCell>
//                     <TableCell><strong>Creaated By</strong></TableCell>
//                     <TableCell><strong>School</strong></TableCell>
//                     <TableCell><strong>Teacher</strong></TableCell>
//                     <TableCell><strong>Student</strong></TableCell>
//                     <TableCell><strong>Urgent</strong></TableCell>
...
//                         <TableCell>
//                           {notice.StartDate ? new Date(notice.StartDate).toLocaleDateString() : "-"}
//                         </TableCell>
//                         <TableCell>
...
export default function NoticeUpdate() {
  ...
  const handleDelete = async (notice) => {
    ...
    try {
      ...
      setNotices((prev) =>
        prev.filter((n) => n.NoticeID !== notice.NoticeID)
      );
      setFiltered((prev) =>
        prev.filter((n) => n.NoticeID !== notice.NoticeID)
      );
