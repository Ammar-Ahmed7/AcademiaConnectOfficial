...
// const ReportDetailofWorkingNonTeachingStaff = ({ month, year }) => {
...
//       // Group staff by designation and count male/female, regular/contract
//       const staffByDesignation = staff.reduce((acc, staffMember) => {
...
//           acc[designation][`${gender}Contract`] += 1;
//         } else if (employmentType.includes("deputation")) {
//           acc[designation][`${gender}Deputation`] += 1;
//         } else {
//           acc[designation][`${gender}Regular`] += 1;
//         }

//         acc[designation].total += 1;

//         return acc;
//       }, {});

//       // Format for table display
//       const formattedData = Object.entries(staffByDesignation).map(
//         ([designation, counts], index) => ({
//           srNo: index + 1,
//           nameOfPost: designation,
//           maleRegular: counts.maleRegular,
//           maleContract: counts.maleContract,
//           maleDeputation: counts.maleDeputation,
//           femaleRegular: counts.femaleRegular,
//           femaleContract: counts.femaleContract,
//           femaleDeputation: counts.femaleDeputation,
//           total: counts.total,
//         })
//       );
...
//       pdf.save("non_teaching_staff_report.pdf");
...
//       const fileName = `non_teaching_staff_${month}_${year}.pdf`;
